...
def valid_report_payload():
      """
          Minimal valid payload to create a ReportCreate instance.
              Based on the real FA-Report-System schema.
                  """
      return {
...
def ntf_report_payload(valid_report_payload):
      """NTF report that reuses images — requires source_report_id."""
      return {
